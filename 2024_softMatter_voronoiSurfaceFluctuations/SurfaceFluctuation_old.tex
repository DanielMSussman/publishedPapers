...
\begin{figure}[t]
    ...
    \includegraphics[width=0.99\columnwidth]{CharlesFigs/BrownianBridge_Trajectories.PNG}
...
\begin{figure}[t]
    \centering    \includegraphics[width=0.49\columnwidth]{CharlesFigs/plot_harmonic_scaling_collapse_inset.png}
    \includegraphics[width=0.49\columnwidth]{CharlesFigs/plot_cusp_scaling_collapse_inset.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\columnwidth]{CharlesFigs/SharpeningFactorFit.PNG}
